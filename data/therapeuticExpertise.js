...
export const therapeuticPageHeader = {
  ...
  subHeading: "Driving Clinical Excellence Across Diverse Therapeutic Areas",
  description:[
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vestibulum bibendum dignissim. Sed quam eros, accumsan nec libero nec, facilisis facilisis enim. In hac habitasse platea dictumst. Vivamus at dui in ligula congue convallis. Nulla facilisi. Integer ut aliquet diam. Proin sit amet semper arcu, in dignissim sem. Morbi euismod, justo at condimentum efficitur, urna ex hendrerit est, in facilisis erat libero a felis. Nulla facilisi.",
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vestibulum bibendum dignissim. Sed quam eros, accumsan nec libero nec, facilisis facilisis enim. In hac habitasse platea dictumst. Vivamus at dui in ligula congue convallis. Nulla facilisi. Integer ut aliquet diam. Proin sit amet semper arcu, in dignissim sem. Morbi euismod, justo at condimentum efficitur, urna ex hendrerit est, in facilisis erat libero a felis. Nulla facilisi.",
  ],
  image: about1,
};
    ...
    capabilityCards: [
      {
        ...
        points: [
          `<strong>Urology:</strong> Partial nephrectomy, bladder dissection`,
          `<strong>Gastrointestinal and Colorectal Surgery:</strong> Rectal resections, cholecystectomy, radical completion cholecystectomy`,
          `<strong>Gynecology:</strong> Malignant hysterectomy, myomectomy, endometriosis surgery, uterine niche repair`,
          `<strong>Abdominal Wall and Metabolic Surgery:</strong> Ventral and inguinal hernia repair, bariatric surgery`,
          `<strong>Breast Surgery:</strong> Nipple-sparing mastectomy`,
          `<strong>Cardiothoracic Surgery:</strong> Robotic minimally invasive thoracic procedures, mitral valve repair and replacement, bilateral internal mammary artery CABG`,
        ],
      },
      {
    ...
    capabilityCards: [
      {
        ...
        points: [
          ...
          "ensuring outputs that are publication-ready, regulator-acceptable, and clinically meaningful.",
        ],
      },
    ],
    missionStatement:
