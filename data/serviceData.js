...
import { about1, DentalClinic, Hematology, Neurology, Orthopedics, Pharmacology } from "@images";

// 1. Sidebar Links
export const quickLinks = [
  { text: "What we do", icon: "bag", path: "/what-we-do" },
  { text: "Who we are", icon: "globe", path: "/who-we-are" },
  { text: "Research Publications", icon: "user", path: "/research-publications" },
  { text: "Therapeutic Expertise", icon: "flask", path: "/therapeutic-expertise" },
  { text: "Training Programs", icon: "money", path: "/training-programs" },
];
...
export const servicePageHeader = {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tempor tellus ante. Mauris vitae egestas massa, eget rutrum quam.',
    image: about1, 
}; 

// 3. Defaults (The data that was previously hardcoded in your component)
